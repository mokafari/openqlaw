...
const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.research.enabled": "Enable Research Features",
  "agents.research.roleSafety": "Role Safety",
  "agents.research.roleSafety.enabled": "Enable Role Safety",
  "agents.research.roleSafety.strictMode": "Role Safety Strict Mode",
  "agents.research.testTimeScaling": "Test-Time Scaling",
  "agents.research.testTimeScaling.enabled": "Enable Test-Time Scaling",
  "agents.research.testTimeScaling.maxPaths": "Max Paths",
  "agents.research.testTimeScaling.qualityTarget": "Quality Target",
  "agents.research.testTimeScaling.complexityThreshold": "Complexity Threshold",
  "agents.research.shareFramework": "Share Framework",
  "agents.research.shareFramework.enabled": "Enable Share Framework",
  "agents.research.shareFramework.logRouting": "Log Routing",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "agents.research": "Experimental research features and capabilities.",
  "agents.research.enabled": "Enable research features globally (default: false).",
  "agents.research.roleSafety": "Role safety controls for agent behavior boundaries.",
  "agents.research.roleSafety.enabled":
    "Enable role safety checks on agent actions (default: true when research enabled).",
  "agents.research.roleSafety.strictMode":
    "Enforce strict role boundary validation (default: false).",
  "agents.research.testTimeScaling": "Test-time compute scaling for quality-sensitive tasks.",
  "agents.research.testTimeScaling.enabled": "Enable test-time scaling (default: false).",
  "agents.research.testTimeScaling.maxPaths": "Maximum parallel exploration paths (default: 4).",
  "agents.research.testTimeScaling.qualityTarget": "Target quality threshold 0-1 (default: 0.9).",
  "agents.research.testTimeScaling.complexityThreshold":
    "Minimum task complexity to trigger scaling (default: 0.5).",
  "agents.research.shareFramework": "Framework for shared agent knowledge and routing.",
  "agents.research.shareFramework.enabled": "Enable share framework (default: false).",
  "agents.research.shareFramework.logRouting": "Log knowledge routing decisions (default: false).",
  "discovery.mdns.mode":
